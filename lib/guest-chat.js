...
import { blindSpotMessage, emotionFocusMessage } from './chat-mode.js';
...
export function createGuestHandler({env=process.env,fetcher=fetch}={}) {
 return async(req,res)=>{
  ...
  try{
   ...
   const modeInstructions = await resolveModeInstructions({ observation: seikanMode, blindSpot, emotionFocus }, { fetcher, env });
   let knowledge=[];
   try{
